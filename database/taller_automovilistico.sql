...
INSERT INTO public.areas(name)
    VALUES ('PINTURA'),('MECANICA GENERAL'),('DESABOLLADURA'),('TIENDA'),('AIRE ACONDICIONADO'),('AREA GENERAL PARA FACTURACION');
...
INSERT INTO public.tipo_trans(name)
   VALUES ('COMPRA ARTICULOS'),('PAGO EMPLEADO'),('COBROS POR SERVICIOS'),('VENTAS ARTICULOS'),('REGISTRO CAJA');
