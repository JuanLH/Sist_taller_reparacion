 ...
 * @author juanlht
 */
public class container_tecnico extends javax.swing.JFrame {

    /**
     * Creates new form container_tecnico
     */
    public container_tecnico() {
        initComponents();
        Coordinates pos = Utilities.getCenterLocation(this);
        this.setLocation(pos.getX(), pos.getY());
        this.setTitle("TECNICO - "+Usuario.getUser().getUsuario());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(container_tecnico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
